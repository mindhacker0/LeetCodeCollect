...
//定理：行列式D等于它的任一行(列)的各个元素与其对应的代数余子式乘积之和。
//范德蒙德行列式证明
//推论：行列式D中任一行（列）的元素与另一行（列）的对应元素的代数余子式乘积之和等于零。 
//克拉默法则：
//对于n元线性方程组，系数所组成的行列式D值不等于0，则线性方程组有唯一解。x(n) = D（n)/D;
//D(n)是把系数行列式D中第n列的元素用方程组右端的常数项代替得到的。
//如果线性方程无解或有不同的解，则他的系数行列式必为零。
//齐次线性方程：常数项都为0
//定理：如果齐次线性方程组的系数行列式值不为0，则齐次线性方程组没有非0解。
//定理：如果齐次线性方程组有非零解（多解情况） ，那么方程的系数行列式必为0。
//拉普拉斯定理：
//在n阶行列式中任取k行(列)，由这k行（列）组成的K阶子式分别与其代数余子式的乘积之和等于行列式的值。
//任取k行，m列的代数余子式计算（-1)**(行列的序数之和)*余子式
console.log(reversePairs([3,4,1,7,8,2,6,5,9]));                
//                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                